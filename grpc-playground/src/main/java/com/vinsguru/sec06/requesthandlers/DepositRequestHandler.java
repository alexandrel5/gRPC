    ...
    public void onNext(DepositRequest depositRequest) {
        ...
        switch (depositRequest.getRequestCase()){
            ...
            case MONEY -> {
                ...
                log.info("Added amount. Account number: {}, New Balance: {}",
                        this.accountNumber,
                        AccountRepository.getBalance(this.accountNumber));
            }
        }
        log.info("Current balance for account {} is {}", this.accountNumber, AccountRepository.getBalance(this.accountNumber));
    }
