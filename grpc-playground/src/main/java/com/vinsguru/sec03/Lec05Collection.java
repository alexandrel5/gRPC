...
public class Lec05Collection {
    ...
    public static void main(String[] args) {
        ...
        var book1 = Book.newBuilder()
                .setAuthor("harry potter - part 1")
                .setAuthor("j k rowling")
                .setPublicationYear(1997)
                .build();
        var book2 = Book.newBuilder().setTittle("harry potter - part 2").setPublicationYear(1998).build();
        var book3 = Book.newBuilder().setTittle("harry potter - part 3").setPublicationYear(1999).build();
